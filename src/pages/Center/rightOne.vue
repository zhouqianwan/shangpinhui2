  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="item in records" :key="item.id">
          <thead>
            <tr>
              <th colspan="5">
                <span class="ordertitle">{{item.expireTime}}　订单编号：{{item.outTradeNo}}<span class="pull-right delete"><img src="./images/delete.png"></span></span>
              </th>
            </tr>
          </thead>
          <tbody>
      ...
      <div class="choose-order">
        <Pagination :total="orderList.total" :pageNo='this.page' :continues='5' :pageSize='limit' @getPageNo='getPageNo'></Pagination>
      </div>
    </div>
  </div>
</template>
